...
if balans >= 300:
    z1 = random.randrange(1,11) # задаём рандомное число от 0 до 11(11 не входит)
    z2 = random.randrange(1,11)
    z3 = random.randrange(1,11)
    print(f'* - {dsp[z1-1]} - * - {dsp[z2-1]} - * -{dsp[z3-1]}')
    if z1==z2==z3:
        ...
        balans -= 300
        if balans >= 300:
            vibor = input('Хотите сыграть ещё? Введите +: ')
            if vibor == '+':
                z1 = random.randrange(1,11) # задаём рандомное число от 0 до 11(11 не входит)
                z2 = random.randrange(1,11)
                z3 = random.randrange(1,11)
                ...
                if z1==z2==z3:
                    ...
                    print(f'Тебе сегодня явно нужно передохнуть. Забирай свои остатки: {balans}')
            else:
